...
public func combine<R1: ValueReducer, R2: ValueReducer>(
...
public func combine<R1: ValueReducer, R2: ValueReducer, R3: ValueReducer>(
    _ o1: ValueObservation<R1>,
    _ o2: ValueObservation<R2>,
...
public func combine<R1: ValueReducer, R2: ValueReducer, R3: ValueReducer, R4: ValueReducer, R5: ValueReducer>(
    _ o1: ValueObservation<R1>,
    _ o2: ValueObservation<R2>,
    _ o3: ValueObservation<R3>,
    _ o4: ValueObservation<R4>,
...
func combine<R1: ValueReducer, R2: ValueReducer>(
    _ r1: R1,
    _ r2: R2)
    -> AnyValueReducer<
    (R1.Fetched, R2.Fetched),
...
func combine<R1: ValueReducer, R2: ValueReducer, R3: ValueReducer>(
    _ r1: R1,
    _ r2: R2,
    _ r3: R3)
    -> AnyValueReducer<
...
func combine<R1: ValueReducer, R2: ValueReducer, R3: ValueReducer, R4: ValueReducer>(
    _ r1: R1,
    _ r2: R2,
    _ r3: R3,
    _ r4: R4)
...
func combine<R1: ValueReducer, R2: ValueReducer, R3: ValueReducer, R4: ValueReducer, R5: ValueReducer>(
    _ r1: R1,
    _ r2: R2,
    _ r3: R3,
    _ r4: R4,
