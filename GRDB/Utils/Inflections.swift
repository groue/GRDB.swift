...
extension String {
    ...
    func convertToSnakeCase() -> String {
        ...
        while let upperCaseRange = rangeOfCharacter(from: CharacterSet.uppercaseLetters,
            ...
            guard let lowerCaseRange = rangeOfCharacter(from: CharacterSet.lowercaseLetters,
                                                        options: [], range: searchRange) else {
            ...
            // If so, we encountered a group of uppercase letters that we should
