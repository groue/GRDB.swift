...
public final class Database {
    ...
    /// user statements.
    lazy var statementCache: StatementCache = StatementCache(database: self)
...
extension Database {
    ...
    public func cachedSelectStatement(_ sql: String) throws -> SelectStatement {
        return try userStatementCache.selectStatement(sql)
    }
    ...
    public func cachedUpdateStatement(_ sql: String) throws -> UpdateStatement {
        return try userStatementCache.updateStatement(sql)
    }
...
extension Database {
    ...
    func selectStatementDidFail(_ statement: SelectStatement) {
        ...
        statementCache.remove(statement)
