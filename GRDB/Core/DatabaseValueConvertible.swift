...
///
///     try String.fetchCursor(db, rawSQL: "SELECT name FROM ...", arguments:...) // Cursor of String
///     try String.fetchAll(db, rawSQL: "SELECT name FROM ...", arguments:...)    // [String]
///     try String.fetchOne(db, rawSQL: "SELECT name FROM ...", arguments:...)    // String?
///
...
///         let urls: DatabaseValueCursor<URL> = try URL.fetchCursor(db, rawSQL: "SELECT url FROM link")
...
///
///     try dbQueue.read { db in
///         let urls: NullableDatabaseValueCursor<URL> = try Optional<URL>.fetchCursor(db, rawSQL: "SELECT url FROM link")
///         while let url = urls.next() { // URL?
///             print(url)
///         }
///     }
...
extension DatabaseValueConvertible {
    ...
    ///
    ///     let names = try String.fetchCursor(db, rawSQL: "SELECT name FROM ...") // Cursor of String
    ...
    /// - returns: A cursor over fetched values.
    /// - throws: A DatabaseError is thrown whenever an SQLite error occurs.
    public static func fetchCursor(_ db: Database, rawSQL sql: String, arguments: StatementArguments = StatementArguments(), adapter: RowAdapter? = nil) throws -> DatabaseValueCursor<Self> {
        return try fetchCursor(db, literal: SQLLiteral(sql: sql, arguments: arguments), adapter: adapter)
    }
    
    /// Returns an array of values fetched from an SQL query.
    ///
    ///     let names = try String.fetchAll(db, rawSQL: "SELECT name FROM ...") // [String]
    ///
    /// - parameters:
    ///     - db: A database connection.
    ///     - sql: An SQL query.
    ...
    /// extracted from the first row.
    ///
    ///     let name = try String.fetchOne(db, rawSQL: "SELECT name FROM ...") // String?
    ///
    /// - parameters:
    ///     - db: A database connection.
    ///     - sql: An SQL query.
...
extension DatabaseValueConvertible {
    ...
    /// - returns: A cursor over fetched values.
    /// - throws: A DatabaseError is thrown whenever an SQLite error occurs.
    public static func fetchCursor(_ db: Database, literal sqlLiteral: SQLLiteral, adapter: RowAdapter? = nil) throws -> DatabaseValueCursor<Self> {
...
///
///     try Optional<String>.fetchCursor(db, rawSQL: "SELECT name FROM ...", arguments:...) // Cursor of String?
///     try Optional<String>.fetchAll(db, rawSQL: "SELECT name FROM ...", arguments:...)    // [String?]
///
///     let statement = try db.makeSelectStatement("SELECT name FROM ...")
...
extension Optional where Wrapped: DatabaseValueConvertible {
    ...
    ///
    ///     let names = try Optional<String>.fetchCursor(db, rawSQL: "SELECT name FROM ...") // Cursor of String?
    ///     while let name = try names.next() { // String?
    ///         ...
    ///     }
    ///
    ...
    /// - returns: A cursor over fetched optional values.
    /// - throws: A DatabaseError is thrown whenever an SQLite error occurs.
    public static func fetchCursor(_ db: Database, rawSQL sql: String, arguments: StatementArguments = StatementArguments(), adapter: RowAdapter? = nil) throws -> NullableDatabaseValueCursor<Wrapped> {
        return try fetchCursor(db, literal: SQLLiteral(sql: sql, arguments: arguments), adapter: adapter)
    }
...
extension Optional where Wrapped: DatabaseValueConvertible {
    ...
    /// - returns: A cursor over fetched optional values.
    /// - throws: A DatabaseError is thrown whenever an SQLite error occurs.
    public static func fetchCursor(_ db: Database, literal sqlLiteral: SQLLiteral, adapter: RowAdapter? = nil) throws -> NullableDatabaseValueCursor<Wrapped> {
        return try fetchCursor(db, SQLRequest<Void>(literal: sqlLiteral, adapter: adapter))
    }
    ...
    /// - returns: An array of optional values.
    /// - throws: A DatabaseError is thrown whenever an SQLite error occurs.
    public static func fetchAll(_ db: Database, literal sqlLiteral: SQLLiteral, adapter: RowAdapter? = nil) throws -> [Wrapped?] {
        return try fetchAll(db, SQLRequest<Void>(literal: sqlLiteral, adapter: adapter))
    }
}
