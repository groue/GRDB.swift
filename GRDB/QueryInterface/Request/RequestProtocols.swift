...
// MARK: - AggregateJoinableRequest

/// The base protocol for all requests that can use association aggregates.
public protocol AggregateJoinableRequest: AggregatingRequest & JoinableRequest & SelectionRequest & TableRequest { }
