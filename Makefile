...
ifdef JAZZY
	$(JAZZY) \
	  ...
	  --github-file-prefix https://github.com/groue/GRDB.swift/tree/v5.0.0-beta.7 \
	  --module-version 5.0.0-beta.7 \
	  --module GRDB \
	  --root-url http://groue.github.io/GRDB.swift/docs/5.0.0-beta.7/ \
