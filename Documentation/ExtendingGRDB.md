...
Build a `COUNT(...)` expression from the [count](#TODO) and [count(distinct:)](#TODO) functions:
...
**If SQLExpressionLiteral reveals too limited for your purpose**, you may have to implement a new type that adopts the [SQLExpression](#TODO) protocol.
