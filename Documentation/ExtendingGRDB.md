...
Build a `COUNT(...)` expression from the [count](http://groue.github.io/GRDB.swift/docs/2.5/Functions.html) and [count(distinct:)](http://groue.github.io/GRDB.swift/docs/2.5/Functions.html) functions:
...
**If SQLExpressionLiteral reveals too limited for your purpose**, you may have to implement a new type that adopts the [SQLExpression](http://groue.github.io/GRDB.swift/docs/2.5/Protocols/SQLExpression.html) protocol.
