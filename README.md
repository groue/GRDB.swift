...
**Latest release**: October 16, 2016 &bull; version 0.88.0 &bull; [CHANGELOG](CHANGELOG.md)
...
- [GRDB Reference](http://cocoadocs.org/docsets/GRDB.swift/0.88.0/index.html) (on cocoadocs.org)
...
See [Configuration](http://cocoadocs.org/docsets/GRDB.swift/0.88.0/Structs/Configuration.html) for more details.
...
- [RowAdapter](http://cocoadocs.org/docsets/GRDB.swift/0.88.0/Protocols/RowAdapter.html): the protocol that lets you define your custom row adapters
- [ColumnMapping](http://cocoadocs.org/docsets/GRDB.swift/0.88.0/Structs/ColumnMapping.html): a row adapter that renames row columns
- [SuffixRowAdapter](http://cocoadocs.org/docsets/GRDB.swift/0.88.0/Structs/SuffixRowAdapter.html): a row adapter that hides the first columns of a row
- [ScopeAdapter](http://cocoadocs.org/docsets/GRDB.swift/0.88.0/Structs/ScopeAdapter.html): the row adapter that groups several adapters together to define scopes
...
- `sqlite3_busy_handler`, `sqlite3_busy_timeout`: see [Configuration.busyMode](http://cocoadocs.org/docsets/GRDB.swift/0.88.0/Structs/Configuration.html)
- `sqlite3_changes`, `sqlite3_total_changes`: see [Database.changesCount and Database.totalChangesCount](http://cocoadocs.org/docsets/GRDB.swift/0.88.0/Classes/Database.html)
...
- `sqlite3_sql`: see [Statement.sql](http://cocoadocs.org/docsets/GRDB.swift/0.88.0/Classes/Statement.html)
- `sqlite3_trace`: see [Configuration.trace](http://cocoadocs.org/docsets/GRDB.swift/0.88.0/Structs/Configuration.html)
- `sqlite3_wal_checkpoint_v2`: see [DatabasePool.checkpoint](http://cocoadocs.org/docsets/GRDB.swift/0.88.0/Classes/DatabasePool.html)
...
First have a detailed look at the full API of [DatabaseQueue](http://cocoadocs.org/docsets/GRDB.swift/0.88.0/Classes/DatabaseQueue.html) and [DatabasePool](http://cocoadocs.org/docsets/GRDB.swift/0.88.0/Classes/DatabasePool.html). Both adopt the [DatabaseReader](http://cocoadocs.org/docsets/GRDB.swift/0.88.0/Protocols/DatabaseReader.html) and [DatabaseWriter](http://cocoadocs.org/docsets/GRDB.swift/0.88.0/Protocols/DatabaseWriter.html) protocols, so that you can write code that targets both classes.
