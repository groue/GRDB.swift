...
**Latest release**: August 6, 2016 &bull; version 0.78.0 &bull; [CHANGELOG](CHANGELOG.md)
...
- [GRDB Reference](http://cocoadocs.org/docsets/GRDB.swift/0.78.0/index.html) (on cocoadocs.org)
...
```
github "groue/GRDB.swift" ~> 0.78.0
```
...
You can now build requests with the following methods: `all`, `select`, `distinct`, `filter`, `group`, `having`, `order`, `reverse`, `limit`.
