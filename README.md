...
**October 31, 2015: GRDB.swift 0.26.0 is out** - [Release notes](CHANGELOG.md). Follow [@groue](http://twitter.com/groue) on Twitter for release announcements and usage tips.
...
```
github "groue/GRDB.swift" == 0.26.0
```
...
- [GRDB Reference](http://cocoadocs.org/docsets/GRDB.swift/0.26.0/index.html) on cocoadocs.org. Beware that it is incomplete: you may prefer reading the inline documentation right into the [source](https://github.com/groue/GRDB.swift/tree/master/GRDB).
