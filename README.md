...
**November 23, 2015: GRDB.swift 0.32.0 is out** - [Release notes](CHANGELOG.md). Follow [@groue](http://twitter.com/groue) on Twitter for release announcements and usage tips.
...
- **[GRDB Reference](http://cocoadocs.org/docsets/GRDB.swift/0.32.0/index.html)** (on cocoadocs.org)
...
```
github "groue/GRDB.swift" == 0.32.0
```
...
See [Configuration](http://cocoadocs.org/docsets/GRDB.swift/0.32.0/Structs/Configuration.html) and [Concurrency](#concurrency) for more details.
