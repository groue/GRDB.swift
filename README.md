...
**February 4, 2016: GRDB.swift 0.43.1 is out** ([changelog](CHANGELOG.md)). Follow [@groue](http://twitter.com/groue) on Twitter for release announcements and usage tips.
...
- [GRDB Reference](http://cocoadocs.org/docsets/GRDB.swift/0.43.1/index.html) (on cocoadocs.org)
...
```
github "groue/GRDB.swift" ~> 0.43.1
```
...
See [Configuration](http://cocoadocs.org/docsets/GRDB.swift/0.43.1/Structs/Configuration.html) and [Concurrency](#concurrency) for more details.
