...
1. [Download](https://github.com/groue/GRDB.swift/releases/tag/0.106.0) a copy of GRDB.swift, or clone its repository and make sure you use the latest tagged version with the `git checkout 0.106.0` command.
