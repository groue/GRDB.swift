GRDB.swift [![Swift](https://img.shields.io/badge/swift-2.3-orange.svg?style=flat)](https://developer.apple.com/swift/) [![Platforms](https://img.shields.io/cocoapods/p/GRDB.swift.svg)](https://developer.apple.com/swift/) [![License](https://img.shields.io/github/license/groue/GRDB.swift.svg?maxAge=2592000)](/LICENSE)
==========

### A Swift application toolkit for SQLite databases.

**Latest release**: September 16, 2016 &bull; version 0.81.1 &bull; [CHANGELOG](CHANGELOG.md)
...
- Swift 3: use the [master branch](https://github.com/groue/GRDB.swift)
...
- [GRDB Reference](http://cocoadocs.org/docsets/GRDB.swift/0.81.1/index.html) (on cocoadocs.org)
...
Swift 2.3 requires CocoaPods 1.1+, currently in beta. Install Cocoapods beta with the following command:
...
pod 'GRDB.swift', :git => 'git@github.com:groue/GRDB.swift', :branch => 'Swift2.3'
```
...
See [Configuration](http://cocoadocs.org/docsets/GRDB.swift/0.81.1/Structs/Configuration.html) for more details.
...
- [RowAdapter](http://cocoadocs.org/docsets/GRDB.swift/0.81.1/Protocols/RowAdapter.html): the protocol that lets you define your custom row adapters
- [ColumnMapping](http://cocoadocs.org/docsets/GRDB.swift/0.81.1/Structs/ColumnMapping.html): a row adapter that renames row columns
- [SuffixRowAdapter](http://cocoadocs.org/docsets/GRDB.swift/0.81.1/Structs/SuffixRowAdapter.html): a row adapter that hides the first columns of a row
- [ScopeAdapter](http://cocoadocs.org/docsets/GRDB.swift/0.81.1/Structs/ScopeAdapter.html): the row adapter that groups several adapters together to define scopes
...
First have a detailed look at the full API of [DatabaseQueue](http://cocoadocs.org/docsets/GRDB.swift/0.81.1/Classes/DatabaseQueue.html) and [DatabasePool](http://cocoadocs.org/docsets/GRDB.swift/0.81.1/Classes/DatabasePool.html). Both adopt the [DatabaseReader](http://cocoadocs.org/docsets/GRDB.swift/0.81.1/Protocols/DatabaseReader.html) and [DatabaseWriter](http://cocoadocs.org/docsets/GRDB.swift/0.81.1/Protocols/DatabaseWriter.html) protocols, so that you can write code that targets both classes.
