...
**Latest release**: December 15, 2016 &bull; version 0.97.0 &bull; [CHANGELOG](CHANGELOG.md)
...
- [GRDB Reference](http://cocoadocs.org/docsets/GRDB.swift/0.97.0/index.html) (on cocoadocs.org)
...
2. [Download](https://github.com/groue/GRDB.swift/releases/tag/v0.97.0) a copy of GRDB.swift, or clone its repository and make sure you use the latest tagged version with the `git checkout v0.97.0` command.
...
See [Configuration](http://cocoadocs.org/docsets/GRDB.swift/0.97.0/Structs/Configuration.html) for more details.
...
Row adapters are values that adopt the [RowAdapter](http://cocoadocs.org/docsets/GRDB.swift/0.97.0/Protocols/RowAdapter.html) protocol. You can implement your own custom adapters, or use one of the four built-in adapters:
...
- `sqlite3_busy_handler`, `sqlite3_busy_timeout`: see [Configuration.busyMode](http://cocoadocs.org/docsets/GRDB.swift/0.97.0/Structs/Configuration.html)
- `sqlite3_changes`, `sqlite3_total_changes`: see [Database.changesCount and Database.totalChangesCount](http://cocoadocs.org/docsets/GRDB.swift/0.97.0/Classes/Database.html)
...
- `sqlite3_sql`: see [Statement.sql](http://cocoadocs.org/docsets/GRDB.swift/0.97.0/Classes/Statement.html)
- `sqlite3_trace`: see [Configuration.trace](http://cocoadocs.org/docsets/GRDB.swift/0.97.0/Structs/Configuration.html)
- `sqlite3_wal_checkpoint_v2`: see [DatabasePool.checkpoint](http://cocoadocs.org/docsets/GRDB.swift/0.97.0/Classes/DatabasePool.html)
...
- [Request](http://cocoadocs.org/docsets/GRDB.swift/0.97.0/Protocols/Request.html): the protocol for all requests
- [TypedRequest](http://cocoadocs.org/docsets/GRDB.swift/0.97.0/Protocols/TypedRequest.html): the protocol for all typed requests
- [SQLRequest](http://cocoadocs.org/docsets/GRDB.swift/0.97.0/Structs/SQLRequest.html): a Request built from raw SQL
- [AnyRequest](http://cocoadocs.org/docsets/GRDB.swift/0.97.0/Structs/AnyRequest.html): a type-erased Request
- [AnyTypedRequest](http://cocoadocs.org/docsets/GRDB.swift/0.97.0/Structs/AnyTypedRequest.html): a type-erased TypedRequest
...
Both DatabaseQueue and DatabasePool adopt the [DatabaseReader](http://cocoadocs.org/docsets/GRDB.swift/0.97.0/Protocols/DatabaseReader.html) and [DatabaseWriter](http://cocoadocs.org/docsets/GRDB.swift/0.97.0/Protocols/DatabaseWriter.html) protocols.
...
- Prepare to setup a [busy handler](https://www.sqlite.org/c3ref/busy_handler.html) with [Configuration.busyMode](http://cocoadocs.org/docsets/GRDB.swift/0.97.0/Structs/Configuration.html)
