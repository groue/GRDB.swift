...
**September 12, 2015: GRDB.swift 0.15.0 is out** - [Release notes](CHANGELOG.md). Follow [@groue](http://twitter.com/groue) on Twitter for release announcements and usage tips.
...
```
github "groue/GRDB.swift" == 0.15.0
```
...
- [GRDB Reference](http://cocoadocs.org/docsets/GRDB.swift/0.15.0/index.html) on cocoadocs.org. Beware that is it incomplete. You may prefer reading the inline documentation right into the [source](https://github.com/groue/GRDB.swift/tree/master/GRDB).
...
**Things turn more complex as soon as there are several connections to a database file.** Here are a few questions you may ask yourself, because you may want to provide answers that are not GRDB defaults:
