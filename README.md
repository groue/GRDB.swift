...
**Latest release**: June 22, 2019 • version 4.1.1 • [CHANGELOG](CHANGELOG.md) • [Migrating From GRDB 3 to GRDB 4](Documentation/GRDB3MigrationGuide.md)
...
- [GRDB Reference](http://groue.github.io/GRDB.swift/docs/4.1/index.html) (generated by [Jazzy](https://github.com/realm/jazzy))
...
let package = Package(
    dependencies: [
        .package(url: "https://github.com/groue/GRDB.swift.git", .upToNextMajor(from: "4.1.1"))
    ]
)
```
...
1. [Download](https://github.com/groue/GRDB.swift/releases/tag/v4.1.1) a copy of GRDB, or clone its repository and make sure you use the latest tagged version with the `git checkout v4.1.1` command.
...
See [Configuration](http://groue.github.io/GRDB.swift/docs/4.1/Structs/Configuration.html) for more details.
...
See [Values](#values) for more information on supported arguments types (Bool, Int, String, Date, Swift enums, etc.), and [StatementArguments](http://groue.github.io/GRDB.swift/docs/4.1/Structs/StatementArguments.html) for a detailed documentation of SQLite arguments.
...
Values can be used as [statement arguments](http://groue.github.io/GRDB.swift/docs/4.1/Structs/StatementArguments.html):
...
Transactions can't be left opened unless you set the [allowsUnsafeTransactions](http://groue.github.io/GRDB.swift/docs/4.1/Structs/Configuration.html) configuration flag:
...
Row adapters are values that adopt the [RowAdapter](http://groue.github.io/GRDB.swift/docs/4.1/Protocols/RowAdapter.html) protocol. You can implement your own custom adapters ([**:fire: EXPERIMENTAL**](#what-are-experimental-features)), or use one of the four built-in adapters, described below.
...
- `sqlite3_busy_handler`, `sqlite3_busy_timeout`: see [Configuration.busyMode](http://groue.github.io/GRDB.swift/docs/4.1/Structs/Configuration.html)
- `sqlite3_changes`, `sqlite3_total_changes`: see [Database.changesCount and Database.totalChangesCount](http://groue.github.io/GRDB.swift/docs/4.1/Classes/Database.html)
...
- `sqlite3_sql`: see [Statement.sql](http://groue.github.io/GRDB.swift/docs/4.1/Classes/Statement.html)
- `sqlite3_trace`: see [Configuration.trace](http://groue.github.io/GRDB.swift/docs/4.1/Structs/Configuration.html)
- `sqlite3_wal_checkpoint_v2`: see [DatabasePool.checkpoint](http://groue.github.io/GRDB.swift/docs/4.1/Classes/DatabasePool.html)
...
See [fetching methods](#fetching-methods) for information about the `fetchCursor`, `fetchAll` and `fetchOne` methods. See [StatementArguments](http://groue.github.io/GRDB.swift/docs/4.1/Structs/StatementArguments.html) for more information about the query arguments.
...
See [DatabaseDateDecodingStrategy](https://groue.github.io/GRDB.swift/docs/4.1/Enums/DatabaseDateDecodingStrategy.html), [DatabaseDateEncodingStrategy](https://groue.github.io/GRDB.swift/docs/4.1/Enums/DatabaseDateEncodingStrategy.html), and [DatabaseUUIDEncodingStrategy](https://groue.github.io/GRDB.swift/docs/4.1/Enums/DatabaseUUIDEncodingStrategy.html) to learn about all available strategies.
...
Raw SQL snippets are also accepted, with eventual [arguments](http://groue.github.io/GRDB.swift/docs/4.1/Structs/StatementArguments.html):
...
- [SQLRequest](http://groue.github.io/GRDB.swift/docs/4.1/Structs/SQLRequest.html) is a fetch request built from raw SQL. For example:
...
- [AnyFetchRequest](http://groue.github.io/GRDB.swift/docs/4.1/Structs/AnyFetchRequest.html): a [type-erased](http://chris.eidhof.nl/post/type-erasers-in-swift/) request.
...
FTS3Pattern are regular [values](#values). You can use them as query [arguments](http://groue.github.io/GRDB.swift/docs/4.1/Structs/StatementArguments.html):
...
FTS5Pattern are regular [values](#values). You can use them as query [arguments](http://groue.github.io/GRDB.swift/docs/4.1/Structs/StatementArguments.html):
...
To fetch the Hall of Fame from the database, we perform two requests: the 10 best players, and the total number of players. Following the Rule 2 of the [Concurrency Guide](#guarantees-and-rules), we make sure the two requests are always performed in a single database access, as below:
...
**[DatabaseRegion](https://groue.github.io/GRDB.swift/docs/4.1/Structs/DatabaseRegion.html) is a type that helps observing changes in the results of a database [request](#requests)**.
...
For more details, see the [reference](http://groue.github.io/GRDB.swift/docs/4.1/Structs/DatabaseRegion.html#/s:4GRDB14DatabaseRegionV10isModified2bySbAA0B5EventV_tF).
...
Both DatabaseQueue and DatabasePool adopt the [DatabaseReader](http://groue.github.io/GRDB.swift/docs/4.1/Protocols/DatabaseReader.html) and [DatabaseWriter](http://groue.github.io/GRDB.swift/docs/4.1/Protocols/DatabaseWriter.html) protocols. DatabaseSnapshot adopts DatabaseReader only.
...
- Prepare to setup a [busy handler](https://www.sqlite.org/c3ref/busy_handler.html) with [Configuration.busyMode](http://groue.github.io/GRDB.swift/docs/4.1/Structs/Configuration.html)
