...
**January 10, 2016: GRDB.swift 0.38.2 is out** - [Release notes](CHANGELOG.md). Follow [@groue](http://twitter.com/groue) on Twitter for release announcements and usage tips.
...
- **[GRDB Reference](http://cocoadocs.org/docsets/GRDB.swift/0.38.2/index.html)** (on cocoadocs.org)
...
```
github "groue/GRDB.swift" ~> 0.38.2
```
...
See [Configuration](http://cocoadocs.org/docsets/GRDB.swift/0.38.2/Structs/Configuration.html) and [Concurrency](#concurrency) for more details.
