...
**April 25, 2016: GRDB.swift 0.59.1 is out** ([changelog](CHANGELOG.md)). Follow [@groue](http://twitter.com/groue) on Twitter for release announcements and usage tips.
...
- [GRDB Reference](http://cocoadocs.org/docsets/GRDB.swift/0.59.1/index.html) (on cocoadocs.org)
...
```
github "groue/GRDB.swift" ~> 0.59.1
```
...
See [Configuration](http://cocoadocs.org/docsets/GRDB.swift/0.59.1/Structs/Configuration.html) for more details.
...
The optional `didInsertWithRowID` method lets the adopting type store its rowID after successful insertion. It is called from an arbitrary dispatch queue.
...
First have a detailed look at the full API of [DatabaseQueue](http://cocoadocs.org/docsets/GRDB.swift/0.59.1/Classes/DatabaseQueue.html) and [DatabasePool](http://cocoadocs.org/docsets/GRDB.swift/0.59.1/Classes/DatabasePool.html). Both adopt the [DatabaseReader](http://cocoadocs.org/docsets/GRDB.swift/0.59.1/Protocols/DatabaseReader.html) and [DatabaseWriter](http://cocoadocs.org/docsets/GRDB.swift/0.59.1/Protocols/DatabaseWriter.html) protocols, so that you can write code that targets both classes.
