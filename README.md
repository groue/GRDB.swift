...
**Latest release**: November 29, 2020 • version 5.2.0 • [CHANGELOG](CHANGELOG.md) • [Migrating From GRDB 4 to GRDB 5](Documentation/GRDB5MigrationGuide.md)
...
- [GRDB Reference](http://groue.github.io/GRDB.swift/docs/5.2/index.html) (generated by [Jazzy](https://github.com/realm/jazzy))
...
See [Configuration](http://groue.github.io/GRDB.swift/docs/5.2/Structs/Configuration.html) for more details.
...
See [Values](#values) for more information on supported arguments types (Bool, Int, String, Date, Swift enums, etc.), and [StatementArguments](http://groue.github.io/GRDB.swift/docs/5.2/Structs/StatementArguments.html) for a detailed documentation of SQLite arguments.
...
Values can be used as [statement arguments](http://groue.github.io/GRDB.swift/docs/5.2/Structs/StatementArguments.html):
...
Transactions can't be left opened unless you set the [allowsUnsafeTransactions](http://groue.github.io/GRDB.swift/docs/5.2/Structs/Configuration.html) configuration flag:
...
See [fetching methods](#fetching-methods) for information about the `fetchCursor`, `fetchAll`, `fetchSet` and `fetchOne` methods. See [StatementArguments](http://groue.github.io/GRDB.swift/docs/5.2/Structs/StatementArguments.html) for more information about the query arguments.
...
Raw SQL snippets are also accepted, with eventual [arguments](http://groue.github.io/GRDB.swift/docs/5.2/Structs/StatementArguments.html):
...
- [AnyFetchRequest](http://groue.github.io/GRDB.swift/docs/5.2/Structs/AnyFetchRequest.html): a type-erased request.
...
**[DatabaseRegion](https://groue.github.io/GRDB.swift/docs/5.2/Structs/DatabaseRegion.html) is a type that helps observing changes in the results of a database [request](#requests)**.
...
For more details, see the [reference](http://groue.github.io/GRDB.swift/docs/5.2/Structs/DatabaseRegion.html#/s:4GRDB14DatabaseRegionV10isModified2bySbAA0B5EventV_tF).
...
Both DatabaseQueue and DatabasePool adopt the [DatabaseReader](http://groue.github.io/GRDB.swift/docs/5.2/Protocols/DatabaseReader.html) and [DatabaseWriter](http://groue.github.io/GRDB.swift/docs/5.2/Protocols/DatabaseWriter.html) protocols. DatabaseSnapshot adopts DatabaseReader only.
...
For more information, see [Double-quoted String Literals Are Accepted](https://sqlite.org/quirks.html#dblquote), and [Configuration.acceptsDoubleQuotedStringLiterals](http://groue.github.io/GRDB.swift/docs/5.2/Structs/Configuration.html#/s:4GRDB13ConfigurationV33acceptsDoubleQuotedStringLiteralsSbvp).
...
[SQLRequest]: http://groue.github.io/GRDB.swift/docs/5.2/Structs/SQLRequest.html
