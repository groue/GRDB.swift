...
**Latest release**: September 28, 2016 &bull; version 0.81.2 &bull; [CHANGELOG](CHANGELOG.md)
...
- [GRDB Reference](http://cocoadocs.org/docsets/GRDB.swift/0.81.2/index.html) (on cocoadocs.org)
...
```
github "groue/GRDB.swift" == 0.81.2
```
...
See [Configuration](http://cocoadocs.org/docsets/GRDB.swift/0.81.2/Structs/Configuration.html) for more details.
...
- [RowAdapter](http://cocoadocs.org/docsets/GRDB.swift/0.81.2/Protocols/RowAdapter.html): the protocol that lets you define your custom row adapters
- [ColumnMapping](http://cocoadocs.org/docsets/GRDB.swift/0.81.2/Structs/ColumnMapping.html): a row adapter that renames row columns
- [SuffixRowAdapter](http://cocoadocs.org/docsets/GRDB.swift/0.81.2/Structs/SuffixRowAdapter.html): a row adapter that hides the first columns of a row
- [ScopeAdapter](http://cocoadocs.org/docsets/GRDB.swift/0.81.2/Structs/ScopeAdapter.html): the row adapter that groups several adapters together to define scopes
...
First have a detailed look at the full API of [DatabaseQueue](http://cocoadocs.org/docsets/GRDB.swift/0.81.2/Classes/DatabaseQueue.html) and [DatabasePool](http://cocoadocs.org/docsets/GRDB.swift/0.81.2/Classes/DatabasePool.html). Both adopt the [DatabaseReader](http://cocoadocs.org/docsets/GRDB.swift/0.81.2/Protocols/DatabaseReader.html) and [DatabaseWriter](http://cocoadocs.org/docsets/GRDB.swift/0.81.2/Protocols/DatabaseWriter.html) protocols, so that you can write code that targets both classes.
