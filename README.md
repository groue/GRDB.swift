...
**Latest release**: January 18, 2018 • version 2.6.0 • [CHANGELOG](CHANGELOG.md)
...
let package = Package(
    dependencies: [
        .package(url: "https://github.com/groue/GRDB.swift.git", from: "2.6.0")
    ]
)
```
...
1. [Download](https://github.com/groue/GRDB.swift/releases/tag/v2.6.0) a copy of GRDB, or clone its repository and make sure you use the latest tagged version with the `git checkout v2.6.0` command.
