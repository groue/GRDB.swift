...
To use SQLCipher with the [Swift Package Manager](https://swift.org/package-manager/), edit the package traits for your Xcode project's Package Dependencies:
- Enable `SQLCipher`
- Disable `SQLite` (and any default trait)
