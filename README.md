...
1. [Download](https://github.com/groue/GRDB.swift/releases/tag/v2.0) a copy of GRDB, or clone its repository and make sure you use the latest tagged version with the `git checkout v2.0` command.
