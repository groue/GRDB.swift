...
**April 5, 2016: GRDB.swift 0.56.0 is out** ([changelog](CHANGELOG.md)). Follow [@groue](http://twitter.com/groue) on Twitter for release announcements and usage tips.
...
- [GRDB Reference](http://cocoadocs.org/docsets/GRDB.swift/0.56.0/index.html) (on cocoadocs.org)
...
```
github "groue/GRDB.swift" ~> 0.56.0
```
...
See [Configuration](http://cocoadocs.org/docsets/GRDB.swift/0.56.0/Structs/Configuration.html) for more details.
...
First have a detailed look at the full API of [DatabaseQueue](http://cocoadocs.org/docsets/GRDB.swift/0.56.0/Classes/DatabaseQueue.html) and [DatabasePool](http://cocoadocs.org/docsets/GRDB.swift/0.56.0/Classes/DatabasePool.html). Both adopt the [DatabaseReader](http://cocoadocs.org/docsets/GRDB.swift/0.56.0/Protocols/DatabaseReader.html) and [DatabaseWriter](http://cocoadocs.org/docsets/GRDB.swift/0.56.0/Protocols/DatabaseWriter.html) protocols.
