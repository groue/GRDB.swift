/// The global SQL interface that we are currently using.
/// Can be swapped out dynamically with: `SQLI = CustomSQLiteInterface()`
nonisolated(unsafe) public var SQLI: SQLiteInterface = defaultSQLiteInterface()

func defaultSQLiteInterface() -> SQLiteInterface! {
    #if canImport(SQLite3)
    if #available(macOS 14.2, *) {
        return SystemSQLiteInterface.system
    } else {
        return nil
    }
    #else
    return nil // TODO: fall back to custom build
    #endif
}
...
public func sqlite3_changes64(_ p0: OpaquePointer!) -> sqlite3_int64 { SQLI.sqlite3_changes64(p0) }
public func sqlite3_total_changes(_ p0: OpaquePointer!) -> Int32 { SQLI.sqlite3_total_changes(p0) }

public func sqlite3_total_changes64(_ p0: OpaquePointer!) -> sqlite3_int64 { SQLI.sqlite3_total_changes64(p0) }
public func sqlite3_interrupt(_ p0: OpaquePointer!) { SQLI.sqlite3_interrupt(p0) }

public func sqlite3_is_interrupted(_ p0: OpaquePointer!) -> Int32 { SQLI.sqlite3_is_interrupted(p0) }
...
public func sqlite3_uri_key(_ z: sqlite3_filename!, _ N: Int32) -> UnsafePointer<CChar>! { SQLI.sqlite3_uri_key(z, N) }

public func sqlite3_filename_database(_ p0: sqlite3_filename!) -> UnsafePointer<CChar>! { SQLI.sqlite3_filename_database(p0) }

public func sqlite3_filename_journal(_ p0: sqlite3_filename!) -> UnsafePointer<CChar>! { SQLI.sqlite3_filename_journal(p0) }

public func sqlite3_filename_wal(_ p0: sqlite3_filename!) -> UnsafePointer<CChar>! { SQLI.sqlite3_filename_wal(p0) }
...
public func sqlite3_create_filename(_ zDatabase: UnsafePointer<CChar>!, _ zJournal: UnsafePointer<CChar>!, _ zWal: UnsafePointer<CChar>!, _ nParam: Int32, _ azParam: UnsafeMutablePointer<UnsafePointer<CChar>?>!) -> sqlite3_filename! { SQLI.sqlite3_create_filename(zDatabase, zJournal, zWal, nParam, azParam) }

public func sqlite3_free_filename(_ p0: sqlite3_filename!) { SQLI.sqlite3_free_filename(p0) }
...
public func sqlite3_error_offset(_ db: OpaquePointer!) -> Int32 { SQLI.sqlite3_error_offset(db) }
...
public func sqlite3_normalized_sql(_ pStmt: OpaquePointer!) -> UnsafePointer<CChar>! { SQLI.sqlite3_normalized_sql(pStmt) }
...
public func sqlite3_stmt_explain(_ pStmt: OpaquePointer!, _ eMode: Int32) -> Int32 { SQLI.sqlite3_stmt_explain(pStmt, eMode) }
...
public func sqlite3_value_encoding(_ p0: OpaquePointer!) -> Int32 { SQLI.sqlite3_value_encoding(p0) }
...
public func sqlite3_db_name(_ db: OpaquePointer!, _ N: Int32) -> UnsafePointer<CChar>! { SQLI.sqlite3_db_name(db, N) }
...
public func sqlite3_txn_state(_ p0: OpaquePointer!, _ zSchema: UnsafePointer<CChar>!) -> Int32 { SQLI.sqlite3_txn_state(p0, zSchema) }
...
public func sqlite3_autovacuum_pages(_ db: OpaquePointer!, _ p0: (@convention(c) (UnsafeMutableRawPointer?, UnsafePointer<CChar>?, UInt32, UInt32, UInt32) -> UInt32)!, _ p1: UnsafeMutableRawPointer!, _ p2: (@convention(c) (UnsafeMutableRawPointer?) -> Void)!) -> Int32 { SQLI.sqlite3_autovacuum_pages(db, p0, p1, p2) }
...
public func sqlite3_stmt_scanstatus(_ pStmt: OpaquePointer!, _ idx: Int32, _ iScanStatusOp: Int32, _ pOut: UnsafeMutableRawPointer!) -> Int32 { SQLI.sqlite3_stmt_scanstatus(pStmt, idx, iScanStatusOp, pOut) }

public func sqlite3_stmt_scanstatus_v2(_ pStmt: OpaquePointer!, _ idx: Int32, _ iScanStatusOp: Int32, _ flags: Int32, _ pOut: UnsafeMutableRawPointer!) -> Int32 { SQLI.sqlite3_stmt_scanstatus_v2(pStmt, idx, iScanStatusOp, flags, pOut) }
public var SQLITE_SCANSTAT_COMPLEX: Int32 { SQLI.SQLITE_SCANSTAT_COMPLEX }

public func sqlite3_stmt_scanstatus_reset(_ p0: OpaquePointer!) { SQLI.sqlite3_stmt_scanstatus_reset(p0) }
