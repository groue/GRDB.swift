...
- **Records**:
    ...
    - **Fetch** ([source](https://github.com/groue/GRDB.swift/blob/master/Tests/Performance/FetchRecordStructTests.swift))
        ...
        It builds records from FMDB's `-[FMResultSet resultDictionary]`, GRDB's built-in [DecodableRecord](https://github.com/groue/GRDB.swift#decodablerecord-protocol) protocol, and the values returned by the high-level query builder of SQLite.swift.
