...
class FTS5TableBuilderTests: GRDBTestCase {
    ...
    func testWithoutBody() {
        assertNoError {
            ...
            try dbQueue.inDatabase { db in
                try db.create(virtualTable: "documents", using: FTS5())
                XCTAssertTrue(sqlQueries.contains("CREATE VIRTUAL TABLE \"documents\" USING fts5"))
    ...
    func testOptions() {
        assertNoError {
            let dbQueue = try makeDatabaseQueue()
            try dbQueue.inDatabase { db in
                try db.create(virtualTable: "documents", ifNotExists: true, using: FTS5())
                XCTAssertTrue(sqlQueries.contains("CREATE VIRTUAL TABLE IF NOT EXISTS \"documents\" USING fts5"))
    ...
    func testAsciiTokenizer() {
        assertNoError {
            ...
            try dbQueue.inDatabase { db in
                ...
                XCTAssertTrue(sqlQueries.contains("CREATE VIRTUAL TABLE \"documents\" USING fts5(tokenize=ascii)"))
    ...
    func testPorterTokenizer() {
        assertNoError {
            ...
            try dbQueue.inDatabase { db in
                ...
                XCTAssertTrue(sqlQueries.contains("CREATE VIRTUAL TABLE \"documents\" USING fts5(tokenize=porter)"))
    ...
    func testUnicode61Tokenizer() {
        assertNoError {
            ...
            try dbQueue.inDatabase { db in
                ...
                XCTAssertTrue(sqlQueries.contains("CREATE VIRTUAL TABLE \"documents\" USING fts5(tokenize=unicode61)"))
    ...
    func testUnicode61TokenizerRemoveDiacritics() {
        assertNoError {
            ...
            try dbQueue.inDatabase { db in
                ...
                XCTAssertTrue(sqlQueries.contains("CREATE VIRTUAL TABLE \"documents\" USING fts5(tokenize=unicode61 \"remove_diacritics=0\")"))
    ...
    func testUnicode61TokenizerSeparators() {
        assertNoError {
            ...
            try dbQueue.inDatabase { db in
                ...
                XCTAssertTrue(sqlQueries.contains("CREATE VIRTUAL TABLE \"documents\" USING fts5(tokenize=unicode61 \"separators=X\")"))
    ...
    func testUnicode61TokenizerTokenCharacters() {
        assertNoError {
            ...
            try dbQueue.inDatabase { db in
                ...
                XCTAssertTrue(sqlQueries.contains("CREATE VIRTUAL TABLE \"documents\" USING fts5(tokenize=unicode61 \"tokenchars=.-\")") || sqlQueries.contains("CREATE VIRTUAL TABLE \"documents\" USING fts5(tokenize=unicode61 \"tokenchars=-.\")"))
