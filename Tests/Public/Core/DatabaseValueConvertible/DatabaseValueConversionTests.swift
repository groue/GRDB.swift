    ...
    func testTextAffinity() {
        ...
        assertNoError {
            ...
            try dbQueue.inTransaction { db in
                ...
                XCTAssertTrue((dbv.unsafeValue() as Bool?) == nil)
                XCTAssertTrue((dbv.unsafeValue() as Int?) == nil)
                XCTAssertTrue((dbv.unsafeValue() as Int32?) == nil)
                XCTAssertTrue((dbv.unsafeValue() as Int64?) == nil)
                XCTAssertTrue((dbv.unsafeValue() as Double?) == nil)
                XCTAssertEqual((dbv.unsafeValue() as String?)!, "0")
                XCTAssertTrue((dbv.unsafeValue() as NSData?) == nil)
            ...
            try dbQueue.inTransaction { db in
                ...
                XCTAssertTrue((dbv.unsafeValue() as Int64?) == nil)
                XCTAssertTrue((dbv.unsafeValue() as Double?) == nil)
                XCTAssertEqual((dbv.unsafeValue() as String?)!, "0.0")
                XCTAssertTrue((dbv.unsafeValue() as NSData?) == nil)
            ...
            try dbQueue.inTransaction { db in
                ...
                XCTAssertTrue((dbv.unsafeValue() as Int64?) == nil)
                XCTAssertTrue((dbv.unsafeValue() as Double?) == nil)
                XCTAssertEqual((dbv.unsafeValue() as String?)!, "3.0e+5")
                XCTAssertTrue((dbv.unsafeValue() as NSData?) == nil)
            ...
            try dbQueue.inTransaction { db in
                ...
                XCTAssertTrue((dbv.unsafeValue() as Int64?) == nil)
                XCTAssertTrue((dbv.unsafeValue() as Double?) == nil)
                XCTAssertEqual((dbv.unsafeValue() as String?)!, "foo")
                XCTAssertTrue((dbv.unsafeValue() as NSData?) == nil)
            ...
            try dbQueue.inTransaction { db in
                ...
                XCTAssertTrue((dbv.unsafeValue() as Int64?) == nil)
                XCTAssertTrue((dbv.unsafeValue() as Double?) == nil)
                XCTAssertTrue((dbv.unsafeValue() as String?) == nil)
                XCTAssertEqual((dbv.unsafeValue() as NSData?), "foo".dataUsingEncoding(NSUTF8StringEncoding))
    ...
    func testRealAffinity() {
        ...
        assertNoError {
            ...
            try dbQueue.inTransaction { db in
                ...
                XCTAssertEqual((dbv.unsafeValue() as Bool?)!, false)
                XCTAssertEqual((dbv.unsafeValue() as Int?)!, 0)
                XCTAssertEqual((dbv.unsafeValue() as Int32?)!, Int32(0))
                XCTAssertEqual((dbv.unsafeValue() as Int64?)!, Int64(0))
                XCTAssertEqual((dbv.unsafeValue() as Double?)!, 0.0)
                XCTAssertTrue((dbv.unsafeValue() as String?) == nil)
                XCTAssertTrue((dbv.unsafeValue() as NSData?) == nil)
            ...
            try dbQueue.inTransaction { db in
                ...
                // Check GRDB conversions from Real storage
                XCTAssertEqual((dbv.unsafeValue() as Bool?)!, true)
                XCTAssertEqual((dbv.unsafeValue() as Int?)!, 300000)
                XCTAssertEqual((dbv.unsafeValue() as Int32?)!, Int32(300000))
                XCTAssertEqual((dbv.unsafeValue() as Int64?)!, Int64(300000))
                XCTAssertEqual((dbv.unsafeValue() as Double?)!, Double(300000))
                XCTAssertTrue((dbv.unsafeValue() as String?) == nil)
                XCTAssertTrue((dbv.unsafeValue() as NSData?) == nil)
            ...
            try dbQueue.inTransaction { db in
                ...
                XCTAssertEqual((dbv.unsafeValue() as Bool?)!, true)
                XCTAssertEqual((dbv.unsafeValue() as Double?)!, 1e20)
                XCTAssertTrue((dbv.unsafeValue() as String?) == nil)
                XCTAssertTrue((dbv.unsafeValue() as NSData?) == nil)
