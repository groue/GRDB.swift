...
extension MutablePersistableRecordEncodableTests {
    ...
    func testTrivialEncodable() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            try value.insert(db)
            let string = try String.fetchOne(db, rawSQL: "SELECT value FROM t1")!
    ...
    func testCustomEncodable() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            try value.insert(db)
            let string = try String.fetchOne(db, rawSQL: "SELECT someColumn FROM t1")!
...
extension MutablePersistableRecordEncodableTests {
    ...
    func testTrivialProperty() throws {
        ...
        try dbQueue.inTransaction { db in
            ...
            try value.insert(db)
            let row = try Row.fetchOne(db, rawSQL: "SELECT * FROM t1")!
...
extension MutablePersistableRecordEncodableTests {
    ...
    func testStructWithDate() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            let dbValue = try DatabaseValue.fetchOne(db, rawSQL: "SELECT date FROM t1")!
    ...
    func testStructWithURL() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            try value.insert(db)
            let dbValue = try DatabaseValue.fetchOne(db, rawSQL: "SELECT url FROM t1")!
            XCTAssert(dbValue.storage.value is String)
    ...
    func testStructWithUUID() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            try value.insert(db)
            let dbValue = try DatabaseValue.fetchOne(db, rawSQL: "SELECT uuid FROM t1")!
    ...
    func testArrayJSONEncoding() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            let rows = try Row.fetchAll(db, rawSQL: "SELECT * FROM record ORDER BY id")
