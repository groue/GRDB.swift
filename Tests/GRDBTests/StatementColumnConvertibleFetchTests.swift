...
class StatementColumnConvertibleFetchTests: GRDBTestCase {
    ...
    func testFetchCursor() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            do {
                ...
                try test(Fetched.fetchCursor(db, SQLLiteral(sql: sql)))
            ...
            do {
                ...
                try test(Fetched.fetchCursor(db, SQLLiteral(sql: sql), adapter: adapter))
    ...
    func testFetchCursorWithInterpolation() throws {
        let dbQueue = try makeDatabaseQueue()
        try dbQueue.inDatabase { db in
            let cursor = try Fetched.fetchCursor(db, SQLLiteral("""
                SELECT \(42)
                """))
    ...
    func testFetchCursorStepFailure() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            do {
                ...
                try test(Fetched.fetchCursor(db, SQLLiteral(sql: sql)), sql: sql)
            ...
            do {
                ...
                try test(Fetched.fetchCursor(db, SQLLiteral(sql: sql), adapter: adapter), sql: sql)
    ...
    func testFetchAll() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            do {
                ...
                try test(Fetched.fetchAll(db, SQLLiteral(sql: sql)))
            ...
            do {
                ...
                try test(Fetched.fetchAll(db, SQLLiteral(sql: sql), adapter: adapter))
    ...
    func testFetchAllWithInterpolation() throws {
        let dbQueue = try makeDatabaseQueue()
        try dbQueue.inDatabase { db in
            let array = try Fetched.fetchAll(db, SQLLiteral("""
                SELECT \(42)
                """))
    ...
    func testFetchAllStepFailure() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            do {
                ...
                try test(Fetched.fetchAll(db, SQLLiteral(sql: sql)), sql: sql)
            ...
            do {
                ...
                try test(Fetched.fetchAll(db, SQLLiteral(sql: sql), adapter: adapter), sql: sql)
        ...
        try dbQueue.inDatabase { db in
            do {
                ...
                do {
                    ...
                    try test(Fetched.fetchOne(db, SQLLiteral(sql: sql)))
                ...
                do {
                    ...
                    try test(Fetched.fetchOne(db, SQLLiteral(sql: sql), adapter: adapter))
    ...
    func testFetchOneWithInterpolation() throws {
        let dbQueue = try makeDatabaseQueue()
        try dbQueue.inDatabase { db in
            let fetched = try Fetched.fetchOne(db, SQLLiteral("""
                SELECT \(42)
                """))
            XCTAssertEqual(fetched!.int, 42)
            XCTAssertTrue(fetched!.fast)
    ...
    func testFetchOneStepFailure() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            do {
                ...
                try test(Fetched.fetchOne(db, SQLLiteral(sql: sql)), sql: sql)
            ...
            do {
                ...
                try test(Fetched.fetchOne(db, SQLLiteral(sql: sql), adapter: adapter), sql: sql)
    ...
    func testOptionalFetchCursor() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            do {
                ...
                try test(Optional<Fetched>.fetchCursor(db, SQLLiteral(sql: sql)))
            ...
            do {
                ...
                try test(Optional<Fetched>.fetchCursor(db, SQLLiteral(sql: sql), adapter: adapter))
    ...
    func testOptionalFetchCursorWithInterpolation() throws {
        let dbQueue = try makeDatabaseQueue()
        try dbQueue.inDatabase { db in
            let cursor = try Optional<Fetched>.fetchCursor(db, SQLLiteral("""
                SELECT \(42)
                """))
            let fetched = try cursor.next()!
            XCTAssertEqual(fetched!.int, 42)
    ...
    func testOptionalFetchCursorCompilationFailure() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            do {
                ...
                try test(Optional<Fetched>.fetchCursor(db, SQLLiteral(sql: sql)), sql: sql)
            ...
            do {
                ...
                try test(Optional<Fetched>.fetchCursor(db, SQLLiteral(sql: sql), adapter: adapter), sql: sql)
    ...
    func testOptionalFetchAll() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            do {
                ...
                try test(Optional<Fetched>.fetchAll(db, SQLLiteral(sql: sql)))
            ...
            do {
                ...
                try test(Optional<Fetched>.fetchAll(db, SQLLiteral(sql: sql), adapter: adapter))
    ...
    func testOptionalFetchAllWithInterpolation() throws {
        let dbQueue = try makeDatabaseQueue()
        try dbQueue.inDatabase { db in
            let array = try Optional<Fetched>.fetchAll(db, SQLLiteral("""
                SELECT \(42)
                """))
            XCTAssertEqual(array[0]!.int, 42)
    ...
    func testOptionalFetchAllStepFailure() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            do {
                ...
                try test(Optional<Fetched>.fetchAll(db, SQLLiteral(sql: sql)), sql: sql)
            ...
            do {
                ...
                try test(Optional<Fetched>.fetchAll(db, SQLLiteral(sql: sql), adapter: adapter), sql: sql)
