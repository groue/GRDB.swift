...
class ValueObservationCombineTests: GRDBTestCase {
    func testCombine2() throws {
        ...
        try dbQueue.write { db in
            try db.execute(rawSQL: "INSERT INTO t1 DEFAULT VALUES")
        }
        try dbQueue.write { db in
            try db.execute(rawSQL: "INSERT INTO t2 DEFAULT VALUES")
        }
        try dbQueue.write { db in
            try db.execute(rawSQL: "DELETE FROM t1")
            try db.execute(rawSQL: "INSERT INTO t1 DEFAULT VALUES")
        }
        try dbQueue.write { db in
            try db.execute(rawSQL: "DELETE FROM t2")
            try db.execute(rawSQL: "INSERT INTO t2 DEFAULT VALUES")
        }
        try dbQueue.write { db in
            try db.execute(rawSQL: "DELETE FROM t1")
    ...
    func testCombine3() throws {
        ...
        try dbQueue.write { db in
            try db.execute(rawSQL: "INSERT INTO t3 DEFAULT VALUES")
        }
        try dbQueue.write { db in
            try db.execute(rawSQL: "DELETE FROM t1")
            try db.execute(rawSQL: "INSERT INTO t1 DEFAULT VALUES")
        ...
        try dbQueue.write { db in
            try db.execute(rawSQL: "DELETE FROM t3")
            try db.execute(rawSQL: "INSERT INTO t3 DEFAULT VALUES")
        }
        try dbQueue.write { db in
            try db.execute(rawSQL: "DELETE FROM t1")
    ...
    func testCombine4() throws {
        ...
        try dbQueue.write { db in
            try db.execute(rawSQL: "INSERT INTO t4 DEFAULT VALUES")
        }
        try dbQueue.write { db in
            try db.execute(rawSQL: "DELETE FROM t1")
            try db.execute(rawSQL: "INSERT INTO t1 DEFAULT VALUES")
        ...
        try dbQueue.write { db in
            try db.execute(rawSQL: "DELETE FROM t4")
            try db.execute(rawSQL: "INSERT INTO t4 DEFAULT VALUES")
        }
        try dbQueue.write { db in
            try db.execute(rawSQL: "DELETE FROM t1")
    ...
    func testCombine5() throws {
        ...
        try dbQueue.write { db in
            try db.execute(rawSQL: "INSERT INTO t5 DEFAULT VALUES")
        }
        try dbQueue.write { db in
            try db.execute(rawSQL: "DELETE FROM t1")
            try db.execute(rawSQL: "INSERT INTO t1 DEFAULT VALUES")
        ...
        try dbQueue.write { db in
            try db.execute(rawSQL: "DELETE FROM t5")
            try db.execute(rawSQL: "INSERT INTO t5 DEFAULT VALUES")
        }
        try dbQueue.write { db in
            try db.execute(rawSQL: "DELETE FROM t1")
