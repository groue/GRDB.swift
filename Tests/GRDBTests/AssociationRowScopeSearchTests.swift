...
class AssociationRowScopeSearchTests: GRDBTestCase {
    override func setup(_ dbWriter: DatabaseWriter) throws {
        try dbWriter.write { db in
            ...
            try db.execute(rawSQL: "INSERT INTO a (id) VALUES (1)")
            try db.execute(rawSQL: "INSERT INTO b (id, aid) VALUES (2, 1)")
            try db.execute(rawSQL: "INSERT INTO c (id, aid, bid) VALUES (3, NULL, 2)")
            try db.execute(rawSQL: "INSERT INTO c (id, aid, bid) VALUES (4, 1, NULL)")
            try db.execute(rawSQL: "INSERT INTO d (id, bid) VALUES (5, 2)")
        }
    }
