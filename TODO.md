...
- [ ] Run truncate optimization tests with and without transaction observer
- [ ] Fix observation broker FIXME
- [ ] Rename DatabasePool.write to unsafeWrite, or make it safe.
