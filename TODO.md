- [ ] DatabaseCursor: we need to be able to make fetch() reuse fetchCursor(). It's glaring in `public extension DatabaseValueConvertible where Self: StatementColumnConvertible {`
- [ ] DatabaseCursor.map
