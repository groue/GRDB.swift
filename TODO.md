...
- [ ] Remove Row.hasNull(String), document that Row.hasNul(atIndex:) exists for optimization purpose
- [ ] Have AdaptedRow go straight to SQLite when possible (avoid DatabaseValue initializer)
