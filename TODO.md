...
- [ ] Paranoid: always assume there are external connections. Wrap DatabaseQueue.read in a transaction, deprecate DatabaseQueue.inDatabase (use unsafeWriteWithoutTransaction or unsafeRead instead).
